...
test('playwright locator with salesforce', async({page})=>{   
    ...
    await page.locator('//input[@role="combobox"][@part="input"]').first().click()
     ...
     await page.locator('//span[text()="Salutation"]//following::div[@class="uiPopupTrigger"]').first().click()
     ...
     await page.locator('//input[@role="combobox"][@part="input"]').last().click()
