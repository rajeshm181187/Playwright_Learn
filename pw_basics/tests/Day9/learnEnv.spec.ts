...
// $env:ENV="qa";npx playwright test readENVfile.spec.ts //code to run
dotenv.config({ path: path.resolve(__dirname, `../../data/${environment}.env`) }); //to set the path of the file
